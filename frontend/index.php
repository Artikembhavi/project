                ...
                <div class="col-lg-7">
                    <div class="section-title position-relative mb-4">
                        <h6 class="d-inline-block position-relative  text-uppercase pb-2"
                            style='color:rgb(228 103 19);'>About Us</h6>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 my-5 pt-5 pb-lg-5">
                    <div class="section-title position-relative mb-4">
                        <h6 class="d-inline-block position-relative text-uppercase pb-2" style='color:rgb(228 103 19);'>
                            Why Choose Us?</h6>
    ...
    <div class="container-fluid px-0 py-5">
        <div class="row mx-0 justify-content-center pt-5">
            <div class="col-lg-6">
                <div class="section-title text-center position-relative mb-4">
                    <h6 class="d-inline-block position-relative text-uppercase pb-2" style='color:rgb(228 103 19);'>Our
                        Courses</h6>
        ...
        <div class="owl-carousel courses-carousel">
            ...
            while ($rw = mysqli_fetch_row($a)) {
                ?>
                <form method="post">
                    <div class="courses-item position-relative" style="height:450px;"
                        href="webdevelopment.php?id=<?php echo $rw[0]; ?>">
                        <img class="img-fluid" src="template/pages/forms/pics/<?php echo $rw[2]; ?>" alt=""
                            style="height:450px;">
                        <div class="courses-text">
                            ...
                            <div class="w-100 bg-white text-center p-4">
                                <a class="btn" style="background-color:rgb(228 103 19); color:white;"
                                    href="webdevelopment.php?id=<?php echo $rw[0]; ?>">Course Detail</a>
                                <button class="btn btn-fw" name="btn2"
                                    style="background-color:rgb(228 103 19); color:white;">Add Course</button>
                            </div>
                        </div>
                    </div>
                </form>
                        ...
                        <form method="post">
                            ...
                            <div class="form-group">
                                <textarea class="form-control border-top-0 border-right-0 border-left-0 p-0" rows="5"
                                    placeholder="Message" required="required" name="Message"></textarea>
                            </div>
                            <div>
                                <button class="btn py-3 px-5" style="background-color:rgb(228 103 19); color:white;"
                                    type="submit" name="btn">Send Message</button>
                            </div>
                        </form>
                    </div>
                </div>
