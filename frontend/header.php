            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mx-auto py-0">
                    ...
                    <!--<div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">All Batches</a>
                        <div class="dropdown-menu m-0">
                            <a href="batch.php" class="dropdown-item">Offline Batches</a>
                            <a href="onlinecourse.php" class="dropdown-item">Online Batches</a>
                ...
                <div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="../frontend/template2/index.php" class="dropdown-item">User Dashboard</a>
                        </div>
                    </div>            
                    <?php
                        }
